...
export const checkoutClientValidator = yup.object().shape({
    ...
    number: yup.number().required('Debe indicar un número').integer('El número debe ser un número entero').positive('El número debe ser positivo'),
    postal_code: yup.number().required('Debe indicar un código postal').integer('El código postal debe ser un número entero').positive('El código postal debe ser positivo'),
